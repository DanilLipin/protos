...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       //Email регистрирующегося пользователя
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` //Пароль регистрирующегося пользователя
}
...
type LoginRequest struct {
	...
	Login string `protobuf:"bytes,2,opt,name=login,proto3" json:"login,omitempty"`               //Пароль входящего пользователя
	AppId int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` //ID приложения, в которое заходит пользователь
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x51, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e,
	...
	0x67, 0x69, 0x6e, 0x12, 0x15, 0x0a, 0x06, 0x61, 0x70, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20,
